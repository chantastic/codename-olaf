/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c68dbd80110f3d1f0ffa39f21a06b100)
// Runtime types generated with workerd@1.20260625.1 2026-06-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	ARTIFACTS: Artifacts;
	INSTANCE_NAME: "Chantastic Cloud";
	INSTANCE_ENV: "production";
	KNOWLEDGE_REPO: "chantastic-knowledge";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INSTANCE_NAME" | "INSTANCE_ENV" | "KNOWLEDGE_REPO" | "KNOWLEDGE_NAMESPACE">> {}
}
